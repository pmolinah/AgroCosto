        ...
        <div class="grid grid-cols-2">
            ...
            <div class="text-left col-span-1 mr-5 border-2 shadow-xl bg-white rounded-lg p-2">
                <div class="w-1/5 px-2">
                    <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Fecha Cosecha
                    </label>
                ...
                <div class="flex">
                    ...
                    <div class="w-1/5 px-2">
                        ...
                        <select
                            ...
                            id="contratista_id" wire:model.defer="contratista_id">
                            <!-- name="contratista_id" -->
                    ...
                    <div class="w-1/5 px-2">
                        <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Bodega</label>
                        <select
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                    ...
                    <div class="w-1/5 px-2">
                        <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Color</label>
                        <select
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                    ...
                    <div class="w-1/5 px-2">
                        <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Kilos</label>
                        <input type="text" wire:model.defer="kilos"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    <div class="w-1/5 px-2 mt-6">
                        <button type="button" wire:click="agregarKilos"
                        ...
                        <!--id="agregarKilos-dehabilitado"-->
                    </div>
                </div>
                <input type="hidden" value="{{ $planificacionDatos->id }}" wire:model.defer="planificacioncosecha_id">
                {{-- tabla --}}
                <div class="mt-3 mb-1">
                    <table class="border-2">
                        <thead class="border-2">
                            <tr class="border-2 bg-gray-300">
                                ...
                                <td class="w-full border-2 mt-3">Color</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="w-full mt-3 border-2">
                                    {{ $cosecha->bodega->bodega }}</td>
                                <td class="w-full mt-3 border-2  text-center">
                                    {{ $cosecha->color->color }}.</td>
                                <td class="w-full mt-3 border-2  text-center">
                                    {{ $cosecha->tarjaenvase }}.</td>
                                <td class="w-full mt-3 border-2  text-center">
                                    {{ $cosecha->kilos }}
                                    <input type="hidden" name="KilosDetalleCosecha[]" value="{{ $cosecha->kilos }}">
                                </td>
                                <td class="w-full mt-3 border-2"><button type="button"
                                        wire:click="ElimnarRegistro('{{ $cosecha->id }}', '{{ $cosecha->tarjaenvase }}')"
            ...
            <div class="text-left col-span-1 mr-5 shadow-xl bg-white rounded-lg p-2">
                ...
                <div class="flex">
                    <div class="px-2">
                        <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Fecha</label>
                ...
                <div class="flex">
                    <div class="px-2">
                        <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Campo</label>
                ...
                <div class="w-full mt-2 rounded-xl border border-gray-200 bg-white py-2 px-2 shadow-md shadow-gray-100">
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <div class="w-1/2 px-2">
                                ...
                                <input type="text" name="region" value="{{ $planificacionDatos->kilosSolicitados }}"
                                    class="text-center block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
