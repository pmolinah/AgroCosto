...
#chartdiv {
            ...
            <aside x-show="isSidebarOpen" x-transition:enter="transition-all transform duration-300 ease-in-out"
                ...
                <nav aria-label="Main"
                    ...
                    <div x-data="{ isActive: false, open: false }">
                        ...
                        @endcan
                        <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                            <a href="{{ route('conciliacion') }}" role="menuitem"
                                class="block p-2 text-sm transition-colors duration-200 rounded-md text-gray-100 hover:text-orange-400">
                                Conciliación&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-plus"></i>
                            </a>
                            ...
                            <a href="{{ route('informe.contable') }}" role="menuitem"
                                class="block p-2 text-sm transition-colors duration-200 rounded-md text-gray-100 hover:text-orange-400">
                                Resumen Contable &nbsp;&nbsp;&nbsp;<i class="fa-regular fa-calendar-days"></i>
                            </a>
                            <!-- <a href="{{ route('Tareas.finalizadas') }}" role="menuitem"
                                class="block p-2 text-sm transition-colors duration-200 rounded-md text-gray-100 hover:text-orange-400">
                                Tareas Realizadas&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-calendar-check"></i></i>
    ...
    {{-- <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <!-- component -->
<div class="py-10 mt-20 p-5 bg-neutral-100">
  <div class="flex bg-white p-5 rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <div class=" mt-20 p-5 bg-neutral-100 rounded-lg shadow-lg shadow-neutral-800 hidden lg:block lg:w-1/2 bg-cover" style="width: 450px; height: 300px; background-image: url('{{ asset('storage/logoAgroplanner.png') }}');"></div>
